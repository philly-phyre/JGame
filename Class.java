...
public enum Class { 
	...
	TITAN("A complete Powerhouse who can learn to manip-ulate the EARTH beneath his/her feet. "
			+ "They have  good perseverance and deal heavy blows more  often than others."),
	
	SCORCHER("The power of the PLANETS channels itself thr-ough the body of the SCORCHER. "
	...
	VOIDED("A Scholar that has extensively studied the VOID and that which lies beyond it. "
			+ "They have a fi-rm knowledge of VOID magic and potion-making, and are effective VOID hunters.");
